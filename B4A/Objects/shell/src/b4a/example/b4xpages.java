...
public static b4a.example.b4xcollections _b4xcollections = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4a.example.b4xcollections.class),"Delegate",b4xpages._delegate,"General",Debug.moduleToString(b4a.example.general.class),"GlobalContext",b4xpages._globalcontext,"Main",Debug.moduleToString(b4a.example.main.class),"mPM",b4xpages._mpm,"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}