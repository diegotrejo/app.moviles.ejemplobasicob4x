...
public static b4a.example.b4xpages _b4xpages = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XPages",Debug.moduleToString(b4a.example.b4xpages.class),"General",Debug.moduleToString(b4a.example.general.class),"Main",Debug.moduleToString(b4a.example.main.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}